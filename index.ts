...
export const ecrRepositoryUrl = appEnv.awsEcrStackRef
  .getOutput("ecrRepositories")
  .apply((repos) => repos[appEnv.name]);

export const dataSyncSecretId =
  appEnv.dataSyncStackRef.getOutput("awsSecretId");
export const dataSyncDatabaseName =
  appEnv.dataSyncStackRef.getOutput("rdsDatabaseName");
